...
st.set_page_config(page_title="Generate Intelligence", page_icon="📈")
st.title("Generate Intelligence")
...
def display_pdf(file):
    ...
    src="data:application/pdf;base64,{base64_pdf}" width="400" height="100%"
...
def display_csv(file):
    df = load_csv(file)
    st.data_editor(df.T, height=300)
...
with st.sidebar:
    ...
    uploaded_file = st.file_uploader("Choose your `.pdf` | `.csv` file", type=["csv", "pdf"])
        ...
        try:
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                if file_key not in st.session_state.get('file_cache', {}):
                    ...
                    # Creating an index overloaded data
                    ...
                    qa_prompt_tmpl_str = (
                        ...
                        "think step by step to answer the query in a crisp manner, incase case you "
...
with col1:
    st.header("Chat with Docs using ⌘ R+")
with col2:
